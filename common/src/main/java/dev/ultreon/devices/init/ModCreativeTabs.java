...
public class ModCreativeTabs {
    private static final Registrar<CreativeModeTab> REGISTER = OmnixerioDevices.REGISTRIES.get().get(Registries.CREATIVE_MODE_TAB);
    public static final RegistrySupplier<CreativeModeTab> TAB_DEVICE = register("device", () -> CreativeTabRegistry.create(builder -> {
        ...
        builder.title(Component.translatable("itemGroup.omnixerio_devices.omnixerio_devices"));
        builder.displayItems((parameters, output) -> {
            ...
            ModItems.CLOCKS.forEach(clock -> output.accept(clock.get()));
        });
    }));
    public static final RegistrySupplier<CreativeModeTab> TAB_UTILITY = register("utility", () -> CreativeTabRegistry.create(builder -> {
        ...
        builder.title(Component.translatable("itemGroup.omnixerio_devices.utility"));
        builder.displayItems((parameters, output) -> {
    ...
    public static final RegistrySupplier<CreativeModeTab> TAB_COMPONENTS = register("components", () -> CreativeTabRegistry.create(builder -> {
        ...
        builder.title(Component.translatable("itemGroup.omnixerio_devices.components"));
        builder.displayItems((parameters, output) -> {
    ...
    public static final RegistrySupplier<CreativeModeTab> TAB_INGREDIENTS = register("ingredients", () -> CreativeTabRegistry.create(builder -> {
        ...
        builder.title(Component.translatable("itemGroup.omnixerio_devices.ingredients"));
        builder.displayItems((parameters, output) -> {
