...
public abstract class OmnixerioDevicesMod {
    ...
    public void registerApplications() {
        ...
        if (Platform.isDevelopmentEnvironment() || OmnixerioDevicesMod.EARLY_CONFIG.enableDebugApps) {
    ...
    public static void setAllowedApps(List<AppInfo> allowedApps) {
        OmnixerioDevicesMod.allowedApps = allowedApps;
    }
    ...
    private static class ProtectedArrayList<T> extends ArrayList<T> {
        ...
        public boolean add(T t) {
            freezeCheck();
            if (stackWalker.getCallerClass() != OmnixerioDevicesMod.class) {
