...
public enum Alphabet implements IIcon {
    ...
    private static final Identifier ALPHABET_ASSET = OmnixerioDevices.id("textures/gui/alphabet.png");
    ...
    public void draw(GuiGraphicsExtractor graphics, Minecraft mc, int x, int y, int color) {
        IIcon.super.draw(graphics, mc, x, y, color);
    }
}
